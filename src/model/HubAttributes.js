...
module.exports = (function () {
  ...
  /**
   * The HubAttributes model module.
   * @module model/HubAttributes
   */

  /**
   * Constructs a <code>HubAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/HubAttributes} obj Optional instance to populate.
   * @return {module:model/HubAttributes} The populated <code>HubAttributes</code> instance.
   */
  ...
  /**
   * Constructs a new <code>HubAttributes</code>.
   * @alias module:model/HubAttributes
   * @class
   * @param name {String} displayable name of the hub
