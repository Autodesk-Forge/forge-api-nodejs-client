...
module.exports = (function () {
  ...
  var constructFromObject = function (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('advanced'))
        obj.advanced = JobStlOutputPayloadAdvanced.constructFromObject(data.advanced, obj && obj.advanced);
    }
    return obj;
  };
   ...
   * @class
   * @param type {module:model/JobStlOutputPayload.TypeEnum} The requested output types. Possible values include dwg, fbx, ifc, iges, obj, step, stl, svf, svf2, thumbnail. For a list of supported types, call the [GET formats](https://developer.autodesk.com/en/docs/model-derivative/v2/reference/http/formats-GET) endpoint.
